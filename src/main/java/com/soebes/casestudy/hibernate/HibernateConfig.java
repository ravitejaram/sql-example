...
public class HibernateConfig {
	...
	public final static String CONNECTION_DRIVER_CLASS = PREFIX
			+ "driver_class";
	public final static String CONNECTION_DIALECT = "hibernate.dialect";

	/**
	 * Make this constructor private to prevent other to create their instances.
	 */
	...
	public static HibernateConfig getInstance() {
		if (configuration == null) {
			...
			// We load the information about the configuration from property
			// file.
