...
/**
 * This class will define the interface for all operations which can be done on
 * the Database. This will define the primary key as a Long object.
 * 
 * @author Karl Heinz Marbaise
 * 
 * @param <T>
 *            The parameter type which is used.
 */
