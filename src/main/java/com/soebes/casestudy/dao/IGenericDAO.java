...
/**
 * This defines an generic DAO interface which will provide the usual CRUD
 * operations.
 * 
 * http://www.ibm.com/developerworks/java/library/j-genericdao.html
 * http://www.ibm.com/developerworks/library/j-dao/
 * 
 * Very interesting: http://www.dhptech.com/node/18
 * 
 * with implementation.
 * http://saloon.javaranch.com/cgi-bin/ubb/ultimatebb.cgi?ubb
 * =get_topic&f=78&t=003917
 * 
 ...
 * 
 * @param <T>
 *            The type of the class which will be used for the DAO
 * @param <I>
 *            The type of the primary key for objects of such kind of class.
 */
public interface IGenericDAO<T, I extends Serializable> {
	...
	/**
	 * persist the given bean without an transaction. User has to be responsible
	 * for it.
	 * 
	 * @param item
	 * @return
